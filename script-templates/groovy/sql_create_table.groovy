 ...
 *
 * Exemple :
 * c:\app\gpmsi\v2.0\gpmsi -script c:\app\gpmsi\v2.0\scripts\groovy\sql_create_table.groovy -a:table mouv -a:colmd etude_mouvements_I_PATIEN-v1_2_colonnes.csv
 * c:\app\gpmsi\v2.0\gpmsi -script c:\app\gpmsi\v2.0\scripts\groovy\sql_create_table.groovy -a:table mouv -a:colmd etude_mouvements_I_PATIEN-v1_2_colonnes.csv -a:jdbcurl "jdbc:h2:./test" -a:jdbcuser sa -a:jdbcpwd "" -a:jdbcdriver "org.h2.Driver"
 */
