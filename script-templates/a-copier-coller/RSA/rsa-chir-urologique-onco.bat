...
rem INCA 2011 de chirurgie urologique oncologique
...
set SCRIPT=%GPMSI_HOME%\scripts\groovy\regles\rsa_chir_urologique_onco.groovy

rem Fichier RSA
set RSA=<mettre_ici_chemin_du_fichier_rsa_en_entree>

rem Fichier de sortie avec les NRSA (par ex. NRSAs_chir_uro_onco.csv), ce sera 'b'
