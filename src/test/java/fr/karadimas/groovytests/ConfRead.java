...
public class ConfRead {
	...
	private void test2() {
		...
		cc.setScriptBaseClass("fr.karadimas.groovytests.MyRecall");
	...
	private void test3() {
		CompilerConfiguration cc = new CompilerConfiguration();
		cc.setScriptBaseClass("fr.karadimas.groovytests.MyAddresses");
		GroovyShell sh = new GroovyShell(cc);
		sh.evaluate("addresses new fr.karadimas.groovytests.MyAddress[0] ");
	}
