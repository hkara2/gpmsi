 ...
 * Exemple :
 * c:\app\gpmsi\v1.1\gpmsi -run fr.karadimas.gpmsi.hapi.MllpToXml -a:input toto.hl7 -a:output toto_hl7.xml
 */
...
public class MllpToXml extends Script {
  ...
  public Object run() {
    ...
    ModelClassFactory mcf = new CustomModelClassFactory("fr.karadimas.gpmsi.hapi") //avec le package pour trouver notre v25.segment.ZBE
